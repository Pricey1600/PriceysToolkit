...
public class SpriteObjectCreator : Editor
{
    ...
    [MenuItem("GameObject/2D Object/Dynamic Sprite")]
    ...
    [MenuItem("GameObject/2D Object/Dynamic Sub-Sprite")]
    public static void createChild(MenuCommand menuCommand)
    {
        ...
        GO.AddComponent<DynamicSubSprite>();
